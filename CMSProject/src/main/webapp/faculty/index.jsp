...
<head>
    ...
    <!-- Favicon -->
    <link rel="icon" type="image/png" sizes="16x16" href="assets/landingsource/img/Acadamex.png">
    ...
    <link href="assets/landingsource/lib/owlcarousel/assets/owl.carousel.min.css" rel="stylesheet">

    <!-- Customized Bootstrap Stylesheet -->
    <link href="assets/landingsource/css/style.css" rel="stylesheet">
</head>
            ...
            <div class="row">
                <div class="col-lg-5 mb-5 mb-lg-0" style="min-height: 500px;">
                    <div class="position-relative h-100">
                        <img class="position-absolute w-100 h-100" src="assets/landingsource/img/about.jpg" style="object-fit: cover;">
                    </div>
                </div>
                <div class="col-lg-7">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-5" style="min-height: 500px;">
                    <div class="position-relative h-100">
                        <img class="position-absolute w-100 h-100" src="assets/landingsource/img/feature.jpg" style="object-fit: cover;">
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="profile-card">
        <div class="container">
            <div class="row">
                <div class="col-md-4">
                    <div class="card">
                        <div class="img2"><img src="assets/landingsource/img/a2.jpeg" alt=""></div>
                        <div class="main-text">
                            <h2>Suraj Kumar</h2>
                ...
                <div class="col-md-4">
                    <div class="card">
                        <div class="img2"><img src="assets/landingsource/img/a4.png" alt=""></div>
                        <div class="main-text">
                ...
                <div class="col-md-4">
                    <div class="card">
                        <div class="img2"><img src="assets/landingsource/img/a6.jpg" alt=""></div>
                        <div class="main-text">
                            <h2>Vachaspathi</h2>
